...
<?php
  ...
  $upd_barang= mysqli_query($koneksi,"select  *  from stok where id ='$id_update_barang' ");
...
<body bgcolor="#e0d4c4">
    <form action="upd_proses_stok.php" method="post">
...
<td align="center" class="pink" >nama</td>
                <td>:</td>
            <td align="center">
                <input type="text" name="nama_barang" value="<?php echo $upd['nama_barang'];?>">
</td></tr>
<td align="center" class="pink">jumlah stok</td>
                <td>:</td>
            <td align="center">
                <input type="text" name="jumlah_stok" value="<?php echo $upd['jumlah_stok'];?>">
</td></tr>
<tr>
