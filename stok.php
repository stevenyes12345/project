...
<div>
  <h3>CEgm</h3>
    ...
    <table  border="0" class="table table-hover table-responsive">
      <tr>
    <td colspan="9." align="center"><a href="tambah_stok.php">TAMBAHKAN DATA </a></td></tr>
        <tr>
        <td>id</TD>
        <td>nama_barang</td>
        <td>jumlah_stok</td>
        ...
        <td><a href="upd_stok.php?update=<?php echo $d['id'];?>">update</td></a>
        <td><a href="delete_stok.php?delete=<?php echo $d['id'];?>">delete</td></a>
        <?php 
       } ?>
    </table>
